...
volatile BYTE ControlTransferBuffer[0x08];
volatile BYTE EndpointFlags[0x01] __attribute__((address(0xE99)));
...
void OutDataStage(void)
{
    ...
    bufferSize = ((WORD)(0x03 & Interfaces[0].Output.Stat) << 8) | (WORD)Interfaces[0].Output.Cnt;
...
void ProcessControlTransfer(void)
{
    if (USTAT == 0)
    {
        ...
        BYTE PID = (Interfaces[0].Output.Stat & 0x3C) >> 2;
        if (PID == 0x0D)
